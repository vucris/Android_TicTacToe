...
public class SubSQLiteHelper extends SQLiteOpenHelper {
    //table name
    ...
    public SubSQLiteHelper(final Context context) {
    ...
    public void onUpgrade(final SQLiteDatabase db, final int oldVersion, final int newVersion) {
        Log
                .w(SubSQLiteHelper.class.getName(), "Upgrading database from version " + oldVersion
                        + " to "
                        + newVersion);
    }
